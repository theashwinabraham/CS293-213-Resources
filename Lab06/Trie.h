...
class Trie {
 private:
  ...
  bool recursiveAddCompletions(TrieNode *node, listOfObjects<string> *&list);
  bool addCompletions(TrieNode *node, listOfObjects<string> *&list);
 ...
 public:
  ...
  //void append_to_list(TrieNode* tr, listOfObjects<string>* &list, string word);
};
